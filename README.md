...
First things first you need to make the libftprintf.a. And after this you can link lib to your project and use
**``int ft_printf(const char *format, ...)``** like usual printf.
